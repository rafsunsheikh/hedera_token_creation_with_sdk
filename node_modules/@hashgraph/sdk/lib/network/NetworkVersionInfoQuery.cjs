...
class NetworkVersionInfoQuery extends _Query.default {
  ...
  _mapResponseHeader(response) {
    const networkGetVersionInfo = /** @type {HashgraphProto.proto.INetworkGetVersionInfoResponse} */
    response.networkGetVersionInfo;
    return /** @type {HashgraphProto.proto.IResponseHeader} */networkGetVersionInfo.header;
  }
  ...
  _mapResponse(response) {
    const info = /** @type {HashgraphProto.proto.INetworkGetVersionInfoResponse} */
    response.networkGetVersionInfo;
