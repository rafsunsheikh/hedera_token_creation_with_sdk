...
class NetworkVersionInfo {
  ...
  static _fromProtobuf(info) {
    return new NetworkVersionInfo({
      protobufVersion: _SemanticVersion.default._fromProtobuf(/** @type {HashgraphProto.proto.ISemanticVersion} */
      info.hapiProtoVersion),
      servicesVersion: _SemanticVersion.default._fromProtobuf(/** @type {HashgraphProto.proto.ISemanticVersion} */
