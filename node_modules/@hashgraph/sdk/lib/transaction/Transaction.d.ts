 ...
 */
export const TRANSACTION_REGISTRY: Map<NonNullable<HashgraphProto.proto.TransactionBody["data"]>, (transactions: HashgraphProto.proto.ITransaction[], signedTransactions: HashgraphProto.proto.ISignedTransaction[], transactionIds: TransactionId[], nodeIds: AccountId[], bodies: HashgraphProto.proto.TransactionBody[]) => Transaction>;
/**
...
export default class Transaction extends Executable<HashgraphProto.proto.ITransaction, HashgraphProto.proto.ITransactionResponse, TransactionResponse> {
     ...
     */
    _removeSignaturesFromTransaction(transaction: HashgraphProto.proto.ISignedTransaction, publicKeyHex: string): Uint8Array[];
    /**
     ...
     */
    _shouldRemoveSignature: (sigPair: HashgraphProto.proto.ISignaturePair, publicKeyHex: string) => boolean;
    /**
