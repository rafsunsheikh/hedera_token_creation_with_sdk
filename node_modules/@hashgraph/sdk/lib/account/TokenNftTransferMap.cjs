  ...
  static _fromProtobuf(transfers) {
    ...
    for (const transfer of transfers) {
      ...
      for (const aa of transfer.nftTransfers != null ? transfer.nftTransfers : []) {
        const sender = _AccountId.default._fromProtobuf(/** @type {HashgraphProto.proto.IAccountID} */
        aa.senderAccountID);
        const recipient = _AccountId.default._fromProtobuf(/** @type {HashgraphProto.proto.IAccountID} */
