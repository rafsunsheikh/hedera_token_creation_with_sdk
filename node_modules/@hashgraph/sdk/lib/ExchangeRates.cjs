...
class ExchangeRates {
  ...
  static _fromProtobuf(rateSet) {
    return new ExchangeRates({
      currentRate: _ExchangeRate.default._fromProtobuf(/** @type {HashgraphProto.proto.IExchangeRate} */
      rateSet.currentRate),
      nextRate: _ExchangeRate.default._fromProtobuf(/** @type {HashgraphProto.proto.IExchangeRate} */
      rateSet.nextRate)
    });
  }
