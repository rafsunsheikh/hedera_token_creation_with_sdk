    ...
    for (const tokenTransfer of tokenTransfers) {
      ...
      for (const transfer of tokenTransfer.nftTransfers != null ? tokenTransfer.nftTransfers : []) {
        transfers.push(new TokenNftTransfer({
          tokenId,
          senderAccountId: _AccountId.default._fromProtobuf(/** @type {HashgraphProto.proto.IAccountID} */
          transfer.senderAccountID),
          receiverAccountId: _AccountId.default._fromProtobuf(/** @type {HashgraphProto.proto.IAccountID} */
