...
class NftId {
  ...
  static _fromProtobuf(id) {
    return new NftId(_TokenId.default._fromProtobuf(/** @type {HashgraphProto.proto.ITokenID} */id.token_ID), id.serialNumber != null ? id.serialNumber : _long.default.ZERO);
  }
